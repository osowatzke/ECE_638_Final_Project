...
num_chirps = 3;            % Number of chirp pulses
...
tx_sig = zeros(num_chirps, length(t));
rx_sig = zeros(num_chirps, length(t));
for k = 1:num_chirps
    ...
    current_t = t - time_delay - (k - 1) * pri; % Time delay and PRI
...
mf_out = zeros(num_chirps, 2 * length(t) - 1);
