...
In this section, we evaluate the performance of an FMCW radar written in MATLAB and configured with the following set of parameters:
	...
	\begin{figure}[H]
	    	\centering
	    	\fbox{\includegraphics[width=0.8\linewidth]{pslr_no_window_no_zpad_best_position.jpg}}
	...
	\begin{figure}[H]
	    	\centering
	    	\fbox{\includegraphics[width=0.8\linewidth]{pslr_no_window_no_zpad_worst_position.jpg}}
	...
	Note that we can improve the PSLR by applying a window. However, this will also degrade the range resolution by increasing the mainlobe width of the range response. We consider a Chebychev with an 80dB peak to sidelobe ratio.
