...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=1\linewidth]{Mix_500-900m}}
...
The final parameter compared for optimized OFDM signal integrity against stand-alone OFDM is the BER vs. SNR. The plot below shows that the BER results align with the expected values and are within the same range as those of OFDM  stand-alone.
