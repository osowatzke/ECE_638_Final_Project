...
In this section, we evaluate the performance of an FMCW radar written in MATLAB and configured with the following set of parameters:
	...
	According to \cite{richards-2005}, the SNR at the receiver is given by the following equation:
	...
	According to \cite{richards-2005}, the SNR at the receiver is related to the transmit power ($P_t$), the wavelength ($\lambda$), and the noise equivalent bandwidth ($\beta_n$) as follows: 
	
	\begin{equation}
		\chi \propto \frac{P_t\lambda^2}{\beta_n}
	\end{equation}
