...
In this paper, we presented a JRC implementation, which used an OFDM 802.11p transmitter and zero forcing to generate RDMs from the OFDM returns. We compared the performance of this system to that of an FMCW radar. We observed that performance of the radar degraded with range and uncompensated doppler shifts. We also observed a degradation in SNR due to a high PAPR and the cyclic prefix of the OFDM symbols - with the high PAPR leading being the primary contributor.
