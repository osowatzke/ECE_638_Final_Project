...
Note that this range resolution is significantly larger than it was for the FMCW radar. In fact, its range resolution is insufficient for automotive radar applications. However, we can design an OFDM system with more bandwidth in the 77 GHz band that will achieve a better range resolution. 
