...
The parameters for the optimized OFDM yield distinct power spectral density and BER vs. SNR results. As anticipated, the total power density decreases by 30 dB, a direct consequence of the increased number of data carriers, which has been multiplied by a factor of 32 compared to OFDM stand-alone. The measured average signal power for both optimized OFDM/Radar and OFDM stand-alone are in the same range (-13 dB).
